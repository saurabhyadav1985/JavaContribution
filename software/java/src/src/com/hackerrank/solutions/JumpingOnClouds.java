 ...
 * 
 * The first line contains an integer , the total number of clouds. The second
 * line contains space-separated binary integers describing clouds where .
 * 
 * Constraints
 * 
 * Output Format
 ...
 * 
 * 4 Explanation 0: Emma must avoid and . She can win the game with a minimum of
 * jumps:
 */
